...
public class Gymiteam_list extends AppCompatActivity implements View.OnClickListener {
    private String key;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gymiteam_list);
        ...
        shopimage=findViewById(R.id.gym_shopimage);
        name=findViewById(R.id.gym_shopname);
        address=findViewById(R.id.gym_shopaddress);
        circleImageView=(CircleImageView)findViewById(R.id.gym_shopcall);
        circleImageView.setOnClickListener(this);
        // set Profile
        databaseReference.child("Gym").child(key).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Glide.with(Gymiteam_list.this).load(shop_url).into(shopimage);
            }
...
//        recycle view
        recyclerView=findViewById(R.id.gymiteamlist);
...
//                    Toast.makeText(getActivity(), ""+iteamkey, Toast.LENGTH_SHORT).show();
                    ...
                    databaseReference.child("GymIteams").child(key)
...
//
                            ...
                            RecyclerView.LayoutManager layoutManager=new LinearLayoutManager(Gymiteam_list.this,LinearLayoutManager.VERTICAL,false);
                            RecyclerView.ItemDecoration itemDecoration=new DividerItemDecoration(Gymiteam_list.this,DividerItemDecoration.VERTICAL);
                            DividerItemDecoration itemDecorator = new DividerItemDecoration(Gymiteam_list.this, DividerItemDecoration.VERTICAL);
                            itemDecorator.setDrawable(ContextCompat.getDrawable(Gymiteam_list.this, R.drawable.divider));
                            recyclerView.addItemDecoration(new DividerItemDecoration(Gymiteam_list.this,
                                    DividerItemDecoration.VERTICAL));
                            recyclerView.setLayoutManager(layoutManager);
                            final MainGymAdepter mainrvAdepter = new MainGymAdepter(Gymiteam_list.this, verticalModelArrayList);
