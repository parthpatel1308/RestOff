...
public class Stationaryiteam_list extends AppCompatActivity implements View.OnClickListener {
    private String key;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stationaryiteam_list);
        ...
        shopimage=findViewById(R.id.stationary_shopimage);
        name=findViewById(R.id.stationary_shopname);
        address=findViewById(R.id.stationary_shopaddress);
        circleImageView=(CircleImageView)findViewById(R.id.stationary_shopcall);
        circleImageView.setOnClickListener(this);
        // set Profile
        databaseReference.child("Stationary").child(key).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Glide.with(Stationaryiteam_list.this).load(shop_url).into(shopimage);
            }
...
//        recycle view
        recyclerView=findViewById(R.id.stationaryiteamlist);
...
//                    Toast.makeText(getActivity(), ""+iteamkey, Toast.LENGTH_SHORT).show();
                    ...
                    databaseReference.child("StationaryIteams").child(key)
...
//
                            ...
                            RecyclerView.LayoutManager layoutManager=new LinearLayoutManager(Stationaryiteam_list.this,LinearLayoutManager.VERTICAL,false);
                            RecyclerView.ItemDecoration itemDecoration=new DividerItemDecoration(Stationaryiteam_list.this,DividerItemDecoration.VERTICAL);
                            DividerItemDecoration itemDecorator = new DividerItemDecoration(Stationaryiteam_list.this, DividerItemDecoration.VERTICAL);
                            itemDecorator.setDrawable(ContextCompat.getDrawable(Stationaryiteam_list.this, R.drawable.divider));
                            recyclerView.addItemDecoration(new DividerItemDecoration(Stationaryiteam_list.this,
                                    DividerItemDecoration.VERTICAL));
                            recyclerView.setLayoutManager(layoutManager);
                            final MainStationaryAdepter mainrvAdepter = new MainStationaryAdepter(Stationaryiteam_list.this, verticalModelArrayList);
