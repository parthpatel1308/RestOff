...
public class Beautyiteam_list extends AppCompatActivity implements View.OnClickListener {
    private String key;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beautyiteam_list);
        ...
        shopimage=findViewById(R.id.beauty_shopimage);
        name=findViewById(R.id.beauty_shopname);
        address=findViewById(R.id.beauty_shopaddress);
        circleImageView=(CircleImageView)findViewById(R.id.beauty_shopcall);
        circleImageView.setOnClickListener(this);
        // set Profile
        databaseReference.child("BeautyParlour").child(key).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Glide.with(Beautyiteam_list.this).load(shop_url).into(shopimage);
            }
...
// Recycle View
        recyclerView=findViewById(R.id.beautyiteamlist);
...
//                    Toast.makeText(getActivity(), ""+iteamkey, Toast.LENGTH_SHORT).show();
                    ...
                    databaseReference.child("BeautyIteams").child(key)
...
//
                            ...
                            RecyclerView.LayoutManager layoutManager=new LinearLayoutManager(Beautyiteam_list.this,LinearLayoutManager.VERTICAL,false);
                            RecyclerView.ItemDecoration itemDecoration=new DividerItemDecoration(Beautyiteam_list.this,DividerItemDecoration.VERTICAL);
                            DividerItemDecoration itemDecorator = new DividerItemDecoration(Beautyiteam_list.this, DividerItemDecoration.VERTICAL);
                            itemDecorator.setDrawable(ContextCompat.getDrawable(Beautyiteam_list.this, R.drawable.divider));
                            recyclerView.addItemDecoration(new DividerItemDecoration(Beautyiteam_list.this,
                                    DividerItemDecoration.VERTICAL));
                            recyclerView.setLayoutManager(layoutManager);
                            final MainBeautyAdepter mainrvAdepter = new MainBeautyAdepter(Beautyiteam_list.this, verticalModelArrayList);
