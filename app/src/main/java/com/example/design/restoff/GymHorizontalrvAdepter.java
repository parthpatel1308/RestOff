...
class GymHorizontalrvAdepter extends RecyclerView.Adapter<GymHorizontalrvAdepter.SubHolder>{
    ...
    @NonNull
    @Override
    public GymHorizontalrvAdepter.SubHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull GymHorizontalrvAdepter.SubHolder subHolder, int i) {
