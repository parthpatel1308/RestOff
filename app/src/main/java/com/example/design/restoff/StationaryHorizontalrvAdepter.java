...
class StationaryHorizontalrvAdepter extends RecyclerView.Adapter<StationaryHorizontalrvAdepter.SubHolder> {
    ...
    public StationaryHorizontalrvAdepter(Context context, ArrayList<Horizontalmodel> horizontalmodelArrayList) {
    ...
    @NonNull
    @Override
    public StationaryHorizontalrvAdepter.SubHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull StationaryHorizontalrvAdepter.SubHolder subHolder, int i) {
